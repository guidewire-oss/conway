...
|----|------------|----------|
| FR-001 | Migrate all form controls to BS form classes, delete the 47-override CSS block | SHOULD |
| FR-002 | Migrate tooltips to BS Tooltip (delegated init); remove the custom tip element | SHOULD |
| FR-003 | Migrate `.seg` groups to BS button groups | SHOULD |
| FR-004 | Resolve the `.card` shadow (rename ours or adopt BS's) | SHOULD |
