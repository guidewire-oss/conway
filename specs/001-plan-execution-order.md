...
- `off` — no org limit; pod tracks, leads, calendars and dependencies are the only
  constraints. Also the mode under which AC 4.2 can be checked, since its
  precondition is "no idle enforced by WIP limits".
