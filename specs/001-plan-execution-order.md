...
retrospective language for this is in `flow-rules-gwcp-notes.md`: *"too many
...
| Q3 | Default concurrent-initiative capacity per lead role. Proposed defaults: PM 2, engineering lead 2, architect 3, programme 4. Are these plausible for GWCP? | Anoop | — | [NEEDS CLARIFICATION] |
