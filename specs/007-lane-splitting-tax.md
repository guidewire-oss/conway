...
**Date:** 2026-08-26
**Story/Ticket:** discovered planning the reference portfolio plan; extends spec 006 Decision 2
**Sprint/Cycle:** n/a
...
Apollo/Mobile at Atlas: 200 effort-weeks. Under wall-clock it ran 225 weeks
...
| NFR-002 | 29×35 the reference plan with splitting | < 2s | schedbench |
...
|--------|---------|--------|----------------|
| Apollo@Atlas finish (from user's view) | w225 wall-clock / w45 all-lanes | earlier than w45 when lanes free early | schedbench + in-browser |
